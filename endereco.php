      ...
      <div class="col-md-6">
        <div class="card shadow-lg border-0 rounded-4">
          <div class="card-body p-4">
            ...
            <form action="form-endereco.php" method="post" id="enderecoForm" autocomplete="off" novalidate>
              <div class="form-floating mb-3">
                <input required type="text" name="formCep" class="form-control" id="cep" placeholder="Digite seu CEP" maxlength="9">
                <label for="cep">CEP</label>
                <span class="text-danger small" id="cepError"></span>
              </div>

              <div class="form-floating mb-3">
                <input required type="text" name="formRua" class="form-control" id="rua" placeholder="Digite sua rua">
                <label for="rua">Rua</label>
                <span class="text-danger small" id="ruaError"></span>
              </div>

              <div class="form-floating mb-3">
                <input required type="text" name="formBairro" class="form-control" id="bairro" placeholder="Digite seu bairro">
                <label for="bairro">Bairro</label>
                <span class="text-danger small" id="bairroError"></span>
              </div>

              <div class="form-floating mb-3">
                <input required type="text" name="formCidade" class="form-control" id="cidade" placeholder="Digite sua cidade">
                <label for="cidade">Cidade</label>
                <span class="text-danger small" id="cidadeError"></span>
              </div>

              <div class="form-floating mb-3">
                <input required type="text" name="formEstado" class="form-control" id="estado" placeholder="Digite seu estado" maxlength="2">
                <label for="estado">Estado</label>
                <span class="text-danger small" id="estadoError"></span>
              </div>

              <div class="form-floating mb-3">
                <input required type="number" name="formNumero" class="form-control" id="numero" placeholder="Número da casa" min="1">
                <label for="numero">Número</label>
                <span class="text-danger small" id="numeroError"></span>
              </div>

              <div class="form-floating mb-4">
                <input type="text" name="formComplemento" class="form-control" id="complemento" placeholder="Apartamento, bloco, etc">
